package com.zdh.readhub.feature.more;
...
import com.zdh.readhub.feature.more.favorites.FavoritesFragment;
import com.zdh.readhub.utils.Utils;
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    switch (which) {
                                        ...
                                        case 1:
                                            ...
                                            Toast.makeText(getContext(), R.string.copy_email_success, Toast.LENGTH_LONG).show();
                                            break;
